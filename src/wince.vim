...
" types (i.e. calls to the WinceAddUberwinGroupType and WinceAddSubwinGroupType user
...
source <sfile>:p:h/wince-state.vim
source <sfile>:p:h/wince-common.vim
source <sfile>:p:h/wince-resolve.vim
source <sfile>:p:h/wince-user.vim

" Wince UI
source <sfile>:p:h/wince-commands.vim
source <sfile>:p:h/wince-mappings.vim

" Reference Definitions
source <sfile>:p:h/wince-help.vim
source <sfile>:p:h/wince-preview.vim
source <sfile>:p:h/wince-quickfix.vim
source <sfile>:p:h/wince-option.vim
source <sfile>:p:h/wince-loclist.vim
