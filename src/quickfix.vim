...
function! RefreshLocationLists(command)
    ...
    " If the current window isn't a location window but has a non-hidden
    " location window, open its location window and then jump back
...
function! RegisterRefLoc()
    ...
    call RegisterCursorHoldCallback(function('RefreshLocationLists'), "", 1, -10)
 endfunction
...
nnoremap <silent> <leader>qh :let qfwinHidden = 1<cr>
" Show the quickfix window
nnoremap <silent> <leader>qs :let qfwinHidden = 0<cr>
